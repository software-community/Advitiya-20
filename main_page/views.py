...
def index(request):
    events_day1 = Events.objects.filter(start_date_time__startswith='2019-02-07').order_by('start_date_time')
    events_day2 = Events.objects.filter(start_date_time__startswith='2019-02-08').order_by('start_date_time')
    events_day3 = Events.objects.filter(start_date_time__startswith='2019-02-09').order_by('start_date_time')
